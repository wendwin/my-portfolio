        ...
        <div class="text-justify text-slate-800 dark:text-white">
            ...
            <div class="my-8 max-w-4xl mx-auto">
                <div v-for="(project, index) in projects" :key="index"
                    class="md:flex justify-between items-stretch gap-4 mb-4 md:mb-8">
                    <!-- Card Kiri -->
                    <div
                        class="w-full md:max-w-xl p-4 md:p-5 rounded-md bg-white border border-slate-300 shadow-md flex flex-col mb-4 md:mb-0 dark:bg-gray-800 dark:border-[#01AFAF]">
                        <h2 class="text-lg md:text-xl font-semibold text-slate-800 dark:text-slate-100 mb-3">{{ index + 1
                            }}. {{
                                project.title }}</h2>
                        <p class="mb-3 text-sm md:text-base dark:text-slate-400">{{ project.description }}</p>
                        <span
                            class="w-fit mb-3 bg-purple-100 text-purple-600 text-xs font-semibold px-2 py-1 rounded-full">
                            {{ project.job }}
                        </span>
                        <span v-for="(tag, tagIndex) in project.tags" :key="tagIndex"
                            class="w-fit bg-purple-100 text-purple-600 text-xs font-semibold px-2 py-1 rounded-full">
                            {{ tag }}
                        </span>
                    ...
                    <!-- Card Kanan -->
                    <div
                        class="flex-1 p-4 bg-white border border-gray-300 shadow-md rounded-md flex flex-col  dark:bg-gray-800 dark:border-[#01AFAF]">
            ...
            <footer class="">
                <div class="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8 lg:pt-24">
                    <div class="text-center">
                        <h2 class="text-3xl font-semibold sm:text-5xl bg-gradient-to-r">Let’s build something great together.</h2>
...
Open to fun ideas, side projects, or anything creative. Hit me up!
                    ...
                    <div
                        ...
                        <p class="text-xs text-gray-500 text-center">&copy; 2025. Faisal Dn | CodeLens.id. All rights reserved.</p>
...
const projects = [
    {
        ...
        tags: ["Flask"],
        description: "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Possimus reprehenderit reiciendis quia? Lorem ipsum dolor sit amet consectetur, adipisicing elit. Possimus reprehenderit reiciendis quia?Lorem ipsum dolor sit amet consectetur, adipisicing elit. Possimus reprehenderit reiciendis quia?",
        image: [
            '/img/product44.webp',
            '/img/product11.webp',
            '/img/product12.webp',
    ...
    },
    {
        ...
        job: 'Fullstack Developer',
        tags: ["Django"],
        description: "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Possimus reprehenderit reiciendis quia?",
        image: [
            '/img/product44.webp',
            '/img/product11.webp',
            '/img/product12.webp',
