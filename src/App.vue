...
<template>
  <div
    class="mx-auto py-6 text-gray-100 bg-white dark:bg-[#0F172A] min-h-screen"
  >
    <nav
      class="mx-auto text-center flex flex-wrap justify-center items-center gap-3 font-inter"
    >
      <router-link
        to="/about"
        class="p-2 px-5 font-medium text-base rounded-md text-slate-800 dark:text-white hover:scale-105 transition ease-in duration-100"
        >About</router-link
      >
      <router-link
        to="/"
    ...
    <div class="fixed bottom-4 right-4 flex justify-end items-center m-3">
      ...
      >
        <span
          class="group inline-flex shrink-0 justify-center items-center size-10"
        >
          <svg
      ...
      <button
        ...
        @click="toggleDark"
        type="button "
        class="block font-medium rounded-full bg-[#01AFAF] text-white hover:scale-105 transition ease-in duration-100 focus:outline-hidden hidden"
      >
        <span
          class="group inline-flex shrink-0 justify-center items-center size-10"
        >
